package com.pmk.test.framework.helpers;
...
public class AndroidHelper extends EventFiringWebDriver {
    ...
    private static AndroidDriver<WebElement> startAppiumDriver() {
        ...
        try {
            ANDROID_DRIVER = new AndroidDriver<>(new URL("http://0.0.0.0:4723/wd/hub"), capabilities);
    ...
    private static DesiredCapabilities getAppiumDesiredCapabilities() {
        File app = new File("C:\\Users\\THINKPAD\\gauravkarvir-cucumber_testng_java-e6c7886\\gauravkarvir-cucumber_testng_java-e6c7886\\tools\\ContactManager.apk");
